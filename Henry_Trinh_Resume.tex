...
\begin{cventries}
  ...
  \cventry
    {Sof\/tware Development Engineer Intern — TypeScript, Java} % Job title
    {Amazon} % Organization
    {Seattle, WA} % Location
    {Jun. 2020 -- Sept. 2020} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        % \item {Constructed pipeline for automated deployments of service with automatic rollbacks to prevent broken releases}
...
\begin{cventries}
  ...
  \cventry
    ...
    {University of California, Los Angeles} % Institution
    {Los Angeles, CA} % Location
    {September 2018 -- March 2022} % Date(s)
    {
      % \vspace{-0.11in}
      % \begin{cvskills}
      %   \cvskill
...
\begin{cvskills}
  ...
  \cvskill
  {Frameworks + Tools} % Type
  {PyTorch, Git, gRPC, React, Qt, MongoDB, Django, Node, Docker, OpenCV, mySQL} % Skillset
