...
\begin{cvskills}
  \cvskill
    {Languages} % Type
    {Python, C/C++, Java, JavaScript, TypeScript, SQL, HTML, CSS} % Skillset

  \cvskill
    {Frameworks + Tools} % Type
    {React, PyTorch, MongoDB, Django, Node, Git, Docker, OpenCV, mySQL, PostgreSQL, Numpy} % Skillset
  
  \cvskill
    {Technologies} % Type
    {Full Stack, Android, Databases, Machine Learning, Computer Vision, SLAM} % Skillset
