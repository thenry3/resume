...
\begin{cventries}
  \cventry
    ...
    {Fall 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Creative Tools Machine Learning}
      \end{cvitems}
    }
  ...
  \cventry
    {Sof\/tware Development Engineer Intern — TypeScript, Java, AWS CloudFormation, CloudWatch, S3} % Job title
    {Amazon} % Organization
    {Seattle, WA} % Location
