  ...
  \cventry
    ...
    {Major GPA: 3.9} % Date(s)
    {
      ...
      \begin{cvskills}
        \cvskill
          {Courses} % Type
          {Data Structures, Algorithms, Operating Systems, Linear Algebra, Sof\/tware Construction Laboratory} % Skillset
      \end{cvskills}
    }
  \vspace{-0.2in}
\end{cventries}
...
\begin{cventries}
  ...
  \vspace{-0.07in}
  \cventry
    {Sof\/tware Engineer Intern (Machine Learning Infrastructure)} % Job title
    {Nuro} % Organization
