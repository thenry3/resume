...
\begin{cventries}
  \cventry
    ...
    {Fall 2020} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Will contribute in Infotainment UI team} 
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Improved scalability and performance for a console's infrastructure by transferring it to serverless architecture} 
